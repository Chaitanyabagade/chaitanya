...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="add_intrest_team_6.php"><li style="background:greenyellow"> Add Intrest </li></a>
    ...
    <form class="form" method="post">
     ...
     if(isset($_POST['number'])){
             ...
             $date=$_POST['date'];
                    ...
                    $sql="INSERT INTO `$database_name`.`team_6_intrest` (`mobile_no`, `intrest_amt`,`date`) VALUES ('$number','$amount','$date')";
                    $conn ->query($sql);
                    $conn ->close();
             if(isset($_POST['number'])){  
                 
                 echo'<meta http-equiv="refresh" content="0;url=add_intrest_team_6.php">';
             }
        }
      $conn=mysqli_connect($server,$username,$password);
