...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="view_accounts_team_8.php"><li> View Accounts</li></a>
      <a href="view_intrest_team_8.php"><li> View Intrest </li></a>
      <a href="view_penalty_team_8.php"><li  style="background:greenyellow"> View Penalty</li></a>
...
<div class="mainpage">
    <br><br><br><br>
    <h2> All Penalty Of Team 8 </h2>
 <?php
     include 'database.php';
      $conn=mysqli_connect($server,$username,$password);
     
                
            $sql1= "SELECT * FROM `$database_name`.`team_8_accounts`";
            $result1= mysqli_query($conn,$sql1);
                ...
                while($row1 = mysqli_fetch_assoc($result1)){   
                     ...
                     $sql2= "SELECT * FROM `$database_name`.`team_8_penalty` where `mobile_no`= $number";
