...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="view_emi_loan_team_1.php"><li  style="background:greenyellow"> view emi loan </li></a>
      <a href="add_deposite_team_1.php"><li>Add Deposite</li></a>
...
<div class="mainpage">
    <br><br><br><br>
    <h2> All EMI Loan Of Team 1 </h2>
 <?php
     include 'database.php';
      $conn=mysqli_connect($server,$username,$password);
     
                
            $sql1= "SELECT * FROM `$database_name`.`team_1_accounts`";
            $result1= mysqli_query($conn,$sql1);
                ...
                while($row1 = mysqli_fetch_assoc($result1)){   
                     ...
                     $sql2= "SELECT * FROM `$database_name`.`team_1_emi_loan` where `mobile_no`= $number";
