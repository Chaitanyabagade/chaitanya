...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="add_penalty_team_8.php"><li style="background:greenyellow"> Add Penalty </li></a>
    ...
    <form class="form" method="post">
     ...
     if(isset($_POST['number'])){
             ...
             $date=$_POST['date'];
                    ...
                    $sql="INSERT INTO `$database_name`.`team_8_penalty` (`mobile_no`, `penalty_amt`,`date`) VALUES ('$number','$amount','$date')";
                    $conn ->query($sql);
                    $conn ->close();
             if(isset($_POST['number'])){  
                 echo'<meta http-equiv="refresh" content="0;url=add_penalty_team_8.php">';
             }
        }
      $conn=mysqli_connect($server,$username,$password);
