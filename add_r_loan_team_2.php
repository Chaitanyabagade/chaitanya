...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="add_r_loan_team_2.php"><li  style="background:greenyellow"> Add R.Loan </li></a>
    ...
    <form class="form" method="post">
     ...
     if(isset($_POST['number'])){
             ...
             $rdate=$_POST['rdate'];
                    ...
                    $sql="INSERT INTO `$database_name`.`team_2_r_loan` (`mobile_no`, `r_loan_amt`,`date`,`return_date`) VALUES ('$number','$amount','$date','$rdate')";
                    $conn ->query($sql);
                    $conn ->close();
             if(isset($_POST['number'])){  
                 echo'<meta http-equiv="refresh" content="0;url=add_r_loan_team_2.php">';
             }
        }
      $conn=mysqli_connect($server,$username,$password);
