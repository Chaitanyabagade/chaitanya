...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="view_penalty_team_1.php"><li> View Penalty</li></a>
       <a href="view_deposite_team_1.php"><li   style="background:greenyellow">View Deposite</li></a>
      ...
      $conn=mysqli_connect($server,$username,$password);
            ...
            $result1= mysqli_query($conn,$sql1);
                ...
                while($row1 = mysqli_fetch_assoc($result1)){   
                     ...
                     $sql2= "SELECT * FROM `$database_name`.`team_1_deposite` where `mobile_no`= $number";
