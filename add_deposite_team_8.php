...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="add_deposite_team_8.php"><li   style="background:greenyellow">Add Deposite</li></a>
    ...
    <form class="form" method="post">
     ...
     if(isset($_POST['number'])){
             ...
             $date=$_POST['date'];
                    ...
                    $sql="INSERT INTO `$database_name`.`team_8_deposite` (`mobile_no`, `deposite_amt`,`date`) VALUES ('$number','$amount','$date')";
                    $conn ->query($sql);
                    $conn ->close();
             if(isset($_POST['number'])){  
                 echo'<meta http-equiv="refresh" content="0;url=add_deposite_team_8.php">';
             }
        }
      $conn=mysqli_connect($server,$username,$password);
