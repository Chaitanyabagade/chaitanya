...
<div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <a href="view_penalty_team_6.php"><li  style="background:greenyellow"> View Penalty</li></a>
      ...
      $conn=mysqli_connect($server,$username,$password);
            ...
            $result1= mysqli_query($conn,$sql1);
                ...
                while($row1 = mysqli_fetch_assoc($result1)){   
                     ...
                     $sql2= "SELECT * FROM `$database_name`.`team_6_penalty` where `mobile_no`= $number";
